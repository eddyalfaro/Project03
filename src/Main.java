...
public class Main {
	public static void main(String[] args) throws IOException {
		 ...
		 * 
		 * In the first part of the printed line is for a year is a leap year or not. In
		 * the second part of the line, calculate the difference between today and the
		 * given date. Today means the server date during execution. At the same time,
		 * save these date in a Hashmap as HashMap<LocalDate, Integer> Keys are in the
		 * text file, for map value use numeric values starting from 1. Output format
		 * is: (for format, use the sample output text file, that would be easier) 2017
		 * is not a leap year, and Difference: 3 years, 5 months, and 9 days. 2014 is
		 * not a leap year, and Difference: 6 years, 7 months, and 16 days.
		 * 
		 */
		 ...
		 * System.out.println("Execution time for the case 2: " + estimatedTime2); //You
		 * can see the difference in two execution times, why? explain in your
		 * documentation.
		 */ }
}